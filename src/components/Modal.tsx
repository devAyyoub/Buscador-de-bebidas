              ...
              >
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-2 sm:w-full sm:max-w-2xl sm:p-6">
                  ...
                  <div className="mt-5 flex justify-between gap-4">
                    ...
                    <button className="w-full rounded bg-orange-600 p-3 font-bold uppercase text-white shadow hover:bg-orange-500" onClick={() => handleClickFavorite(selecedRecipe)}>
                      {favoriteExists(selecedRecipe.idDrink) ? 'Eliminar de favoritos' : 'Agregar a favoritos'}
                    </button>
                  </div>
                </Dialog.Panel>
              </Transition.Child>
